...
public class CalicoTypes {
    ...
    public enum Cat{
        Millie ("data/calico/images/cats/millie.png", "data/calico/images/cats/token/millie.png", 3, 3, 1, new int[][][][] {{{{3}}}}, true),
        Tibbit ("data/calico/images/cats/tibbit.png", "data/calico/images/cats/token/tibbit.png", 5, 4, 1, new int[][][][] {{{{4}}}}, true),
        Coconut ("data/calico/images/cats/coconut.png", "data/calico/images/cats/token/coconut.png", 7, 5, 2, new int[][][][] {{{{5}}}}, true),
        Tecolote ("data/calico/images/cats/tecolote.png", "data/calico/images/cats/token/tecolote.png", 7, 4, 2, TecoloteArrangement, false), //in a straightline
        Callie ("data/calico/images/cats/callie.png", "data/calico/images/cats/token/callie.png", 3, 3, 1, CallieArrangement, false), //in a T shape
        Rumi ("data/calico/images/cats/rumi.png", "data/calico/images/cats/token/rumi.png", 5, 3, 1, RumiArrangement, false), //in a stright line
        Gwen ("data/calico/images/cats/gwen.png", "data/calico/images/cats/token/gwen.png", 11, 7, 3, new int[][][][] {{{{7}}}}, true),
        Cira ("data/calico/images/cats/cira.png", "data/calico/images/cats/token/cira.png", 9, 6, 2, new int[][][][] {{{{6}}}}, true),
        Leo ("data/calico/images/cats/leo.png", "data/calico/images/cats/token/leo.png", 11, 5, 3, LeoArrangement, false), //in a stright line
        Almond ("data/calico/images/cats/almond.png", "data/calico/images/cats/token/almond.png", 9, 5, 2, AlmondArrangement, false); //pyramid
        ...
        Cat(String imagePath, String tokenPath, int points, int size, int difficulty, int[][][][] arrangement, boolean patchVer) {
            this.imagePath = imagePath;
