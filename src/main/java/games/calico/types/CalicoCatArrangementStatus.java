 ...
 */
public class CalicoCatArrangementStatus {
    int sizeFound;
    boolean validArrangement;

        //for init
    public CalicoCatArrangementStatus (int sizeFound, boolean validArrangement) {
        updateParams(sizeFound, validArrangement);
    }
